...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"../docs/index.js":[function(require,module,exports) {
var define;
parcelRequire = function (e, r, t, n) {
  ...
  "i17t": [function (require, module, exports) {
    ...
    function sl(e, n, t, r, l) {
      ...
      Te(function () {
        ...
        if (0 == (7 & n)) {
          ...
          if ("select" === (i = (o = r ? Vl(r) : window).nodeName && o.nodeName.toLowerCase()) || "input" === i && "file" === o.type) var g = dr;else if (ur(o)) {
            if (pr) g = Sr;else {
              g = kr;
              var v = br;
            }
    ...
    Zo = function (e, n) {
      ...
      if (a !== r) {
        ...
        for (c in r) {
          var s = r[c];
          if (i = null != a ? a[c] : void 0, r.hasOwnProperty(c) && s !== i && (null != s || null != i)) if ("style" === c) {
            if (i) {
    ...
    qi = function (e, n, r) {
      if (null !== e) {
        if (e.memoizedProps !== n.pendingProps || Kl.current) Ao = !0;else {
    ...
    !function (t, n) {
      ...
      function ae(e) {
        ...
        var x = t.useCallback(function (e, t) {
          ...
          I = h(e),
          G = f(m().getToggleAllRowsExpandedProps, {
            instance: I()
          });
        Object.assign(e, {
          preExpandedRows: o,
      ...
      function Be(e, t, n, o) {
        ...
        if (t.type === l.setGlobalFilter) {
          var u = t.filterValue,
            s = o.userFilterTypes,
            a = G(o.globalFilter, s || {}, be),
            c = m(u, e.globalFilter);
          return A(a.autoRemove, c) ? (e.globalFilter, i(e, ["globalFilter"])) : r({}, e, {
            globalFilter: c
          });
        }
      }
      ...
      function nt(e, t, n, o) {
        ...
        if (t.type === l.resetPivot) return r({}, e, {
          pivotColumns: o.initialState.pivotColumns || et
        });
      ...
      var Ft = function (e) {
          e.getResizerProps = [Gt], e.getHeaderProps.push({
            style: {
              position: "relative"
            }
          }), e.stateReducers.push(At), e.useInstance.push(Ht), e.useInstanceBeforeDimensions.push(kt);
        },
        Gt = function (e, t) {
          var n = t.instance,
            o = t.header,
      ...
      e._UNSTABLE_usePivotColumns = Ze, e.actions = l, e.defaultColumn = c, e.defaultGroupByFn = je, e.defaultOrderByFn = $e, e.defaultRenderer = s, e.emptyRenderer = a, e.ensurePluginOrder = v, e.flexRender = b, e.functionalUpdate = m, e.loopHooks = g, e.makePropGetter = f, e.makeRenderer = R, e.reduceHooks = p, e.safeUseLayoutEffect = y, e.useAbsoluteLayout = zt, e.useAsyncDebounce = function (e, n) {
        ...
        var H = t.useMemo(function () {
          return p(s().allColumns, S(k), {
            instance: u()
          }).map(C);
        }, [k, s, u].concat(p(s().allColumnsDeps, [], {
          instance: u()
        })));
        u().allColumns = H;
        ...
        var M = t.useMemo(function () {
          return p(s().visibleColumns, H, {
            instance: u()
          }).map(function (e) {
            return x(e, m);
          });
        }, [s, H, u, m].concat(p(s().visibleColumnsDeps, [], {
          instance: u()
        })));
        ...
        }, [s, M, m, u].concat(p(s().headerGroupsDeps, [], {
          instance: u()
        })));
        u().headerGroups = j;
        ...
        }, [s, u, H, M]), u().getTableProps = f(s().getTableProps, {
          instance: u()
  ...
  "QETx": [function (require, module, exports) {
    "use strict";
    ...
    function a(r) {
      var a = r.columns,
        ...
        u = n.getTableProps,
        o = n.getTableBodyProps,
        c = (n.headerGroups, n.rows),
        d = n.prepareRow;
      return e.default.createElement("table", u(), e.default.createElement("tbody", o(), c.map(function (t, r) {
        return d(t), e.default.createElement("tr", t.getRowProps(), t.cells.map(function (t) {
          return e.default.createElement("td", t.getCellProps(), t.render("Cell"));
        }));
      })));
    }
    function l(t) {
      var r = t.data,
        l = e.default.useMemo(function () {
          return [{
            Header: "Title",
            Cell: function (t) {
              return e.default.createElement("a", {
                className: "DocLink",
                href: t.row.original.link
  ...
  "jSXN": [function (require, module, exports) {
    "use strict";
    ...
    exports.FilterButton = r;
  }, {
    "react": "n8MK"
  }],
  "hX60": [function (require, module, exports) {
    "use strict";
    ...
    var i = function (r) {
      ...
      }, "Filter"), e.default.createElement("div", {
        className: "filterlist"
      }, a.map(function (r) {
        return e.default.createElement(t.FilterButton, {
          key: r,
          tag: r,
          onClick: function () {
            return l(r);
  ...
  "FOZT": [function (require, module, exports) {
    ...
    Object.defineProperty(exports, "__esModule", {
      value: !0
    }), exports.getTags = exports.getFilteredData = void 0;
    var a = function (r) {
      var e = r.reduce(function (r, e) {
        var n,
          o = null === (n = e.tags) || void 0 === n ? void 0 : n.split(",");
        return o && r.push.apply(r, t(o)), r;
      }, []);
      return t(new Set(e));
    };
    exports.getTags = a;
    var u = function (t, r) {
      return (null == r ? void 0 : r.length) <= 0 ? t : t.filter(function (t) {
        var e;
        return null === (e = t.tags) || void 0 === e ? void 0 : e.split(",").includes(r);
      });
    };
    exports.getFilteredData = u;
  }, {}],
  "bS30": [function (require, module, exports) {
    "use strict";
    ...
    var e = l(require("react")),
      t = require("./DocumentTable"),
      r = require("./FilterList"),
      n = require("./utils");
    function a(e) {
      ...
      if (null != r) {
        ...
        try {
          if (l = (r = r.call(e)).next, 0 === t) {
            ...
            o = !1;
          } else for (; !(o = (n = l.call(r)).done) && (u.push(n.value), u.length !== t); o = !0);
        } catch (f) {
          c = !0, a = f;
        } finally {
          try {
    ...
    var d = function (a) {
      var l = a.data,
        ...
        c = o[0],
        f = o[1];
      return e.default.createElement(e.default.Fragment, null, e.default.createElement("div", {
        className: "TitleContainer"
      }, e.default.createElement("div", {
        className: "title"
      }, "Resource Library")), e.default.createElement("div", {
        className: "library"
      }, e.default.createElement(r.FilterList, {
        tags: u,
        filterFunction: f
      }), e.default.createElement(t.DocTable, {
        data: (0, n.getFilteredData)(l, c)
      })));
    };
    exports.Library = d;
  }, {
  ...
  "lY9v": [function (require, module, exports) {
    ...
    function u(t) {
      var a = t.domElement.getAttribute("data");
      return e.default.createElement("div", {
        className: "App"
      }, e.default.createElement("header", {
        className: "App-header"
      }, e.default.createElement(r.Library, {
        data: JSON.parse(a)
      })));
    }
    var d = u;
  ...
  "Focm": [function (require, module, exports) {
    ...
    var l = document.querySelectorAll(".doc-lib");
    l.forEach(function (u) {
      r.default.render(e.default.createElement(e.default.StrictMode, null, e.default.createElement(t.default, {
        domElement: u
      })), u);
    });
  }, {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "63367" + '/');
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","../docs/index.js"], null)
//# sourceMappingURL=/docs.d57d9cf6.js.map